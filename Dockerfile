...
RUN javac \
    -cp "/usr/local/tomcat/lib/servlet-api.jar:/usr/local/tomcat/lib/mysql-connector-j-26.7.0.jar:/usr/local/tomcat/lib/jakarta.mail-api-2.1.3.jar:/usr/local/tomcat/lib/angus-mail-2.0.5.jar" \
